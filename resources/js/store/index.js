export default {
    ...
    actions:{
        allCategory(context){
            axios.get('/blog/public/category')
                .then((response)=>{
                    context.commit('categoreis',response.data.categories)
                })
        },
        gelAllPost(context){
            axios.get('/blog/public/post')
                .then((response)=>{
        ...
        getblogPost(context){
            axios.get('/blog/public/blogpost')
                .then((response)=>{
                    // console.log(response.data)
        ...
        getPostById(context,payload){
            axios.get('/blog/public/singlepost/'+payload)
                .then((response)=>{
        ...
        getPostByCatId(context,payload){
            axios.get('/blog/publid/categorypost/'+payload)
                .then((response)=>{
        ...
        SearchPost(context,payload){
            axios.get('/blog/public/search?s='+payload)
                .then((response)=>{
        ...
        latestPost(context){
            axios.get('/blog/public/latestpost')
                .then((response)=>{
                    // console.log(response.data)
