              ...
              <div class="row">
                <div class="span8">
                  <div class="post-image">
                    ...
                    <img :src="`uploadimage/${post.photo}`" alt="" width="800" height="400" />
                  </div>
                  <p>
                  ...
                  <div class="bottom-article">
                    ...
                    <router-link :to="`/blog/public/blog/${post.id}`" class="pull-right">Continue reading <i class="icon-angle-right"></i></router-link>
                  </div>
                </div>
              </div>
            </article>
