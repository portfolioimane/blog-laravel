                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button class="btn btn-primary">
                                    <router-link to="/blog/public/add-category" style="color:#fff"> Add Category</router-link>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr v-for="(category,index) in getallCategory" :key="category.id">
                                    ...
                                    <td>
                                        <router-link :to="`/blog/public/edit-category/${category.id}`">Edit</router-link>
...
<script>
    export default {
        ...
        methods:{
            deletecategory(id){
               axios.get('/blog/public/category/'+id)
                   .then(()=>{
                       this.$store.dispatch("allCategory")
                       toast({
                           type: 'success',
            ...
            deleteSelected(){
               ...
               axios.get('/blog/public/deletecategory/'+this.categoryItem)
                   .then(()=>{
                       this.categoryItem = []
                       this.$store.dispatch("allCategory")
                       toast({
