...
<script>
    export default {
        name: "Edit",
        mounted(){
            axios.get(`/blog/public/editcategory/${this.$route.params.categoryid}`)
                .then((response)=>{
        ...
        methods:{
            updateCategory(){
                this.form.post(`/blog/public/update-category/${this.$route.params.categoryid}`)
                    .then((response)=>{
                        this.$router.push('/blog/public/category-list')
                        toast({
                            type: 'success',
